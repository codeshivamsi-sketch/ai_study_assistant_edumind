...
module.exports = (_env, argv) => {
  ...
  return {
    entry: "./src/index.tsx", // dev-harness only; the exposed widgets are the real federation contract
            ...
            "style-loader",
            {
              ...
              options: {
                modules: {
                  ...
                  localIdentName: "notifications__[name]__[local]__[hash:base64:5]",
                },
              },
            },
          ],
    ...
    plugins: [
      ...
      new container.ModuleFederationPlugin({
        ...
        exposes: {
          ...
          "./NotificationsPage": "./src/NotificationsPage",
        },
        shared: {
